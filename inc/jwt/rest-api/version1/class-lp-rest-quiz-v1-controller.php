				...
				'questions'         => array(
					...
					'items'       => array(
						...
						'items'       => array(
							...
							*/
							'paragraph' => array(
								'description' => __( 'Paragraph details.', 'learnpress' ),
								'type'        => 'array',
								'context'     => array( 'view', 'edit' ),
								'items' 	  => array(
								'items'       => array(
									'description' => __( 'Paragraph items.', 'learnpress' ),
									'type'        => 'object',
									'context'     => array( 'view', 'edit' ),
									'items'       => array(
										'title' => array(
											'description' => __( 'Paragraph title.', 'learnpress' ),
											'type'        => 'string',
											'context'     => array( 'view', 'edit' ),
										),
										'content' => array(
											'description' => __( 'Paragraph content.', 'learnpress' ),
											'type'        => 'string',
											'context'     => array( 'view', 'edit' ),
										),
									),
