    ...
    $Vue.component('lp-quiz-question-actions', {
        ...
        methods: {
            ...
            active: function(type) {
                ...
                if (supportTypes.indexOf(type) === -1 || supportTypes.indexOf(this.question.type
                        .key) === -1) {
            ...
            deletePermanently: function() {
                if (!confirm($store.getters['i18n/all'].confirm_trash_question.replace(
            ...
            getQuestionsSupportAnswerOptions: function() {
                var supportTypes = $store.getters['lqs/supportAnswerOptions'];
                return supportTypes.indexOf(this.question.type.key) !== -1 ? lodash.pick(this
                    .questionTypes, supportTypes) : false;
            }
        }
    });
});
